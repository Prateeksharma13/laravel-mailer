...
<html lang="en">
  <head>
    ...
    <title>Accept delete event </title>
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet">
    <!-- <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"> -->
  </head>
  <body style="  width:600px; margin: auto; position: relative; font-family: sans-serif; font-size: 14px; line-height: 1.42857143;
  color: #333;background-color: #fff;">
    <table class="emailer-bg" style="width:600px; margin:auto;">
      <tr>
        ...
        <table class="content" style="width:600px; margin:auto; margin-bottom:60px;">
          <tr class="left-con" style="width:100%;">
            <td class="left" style="width:40%; vertical-align: top; padding-top: 30px;">
            ...
            <td class="right" style="width:60%;">
                <p style="font-size:15px; padding-top:35px; margin: 0 0 10px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                <div class="venue" style="margin-top:20px">
                  <h6 style="font-size:14px; font-family: Montserrat-Bold; font-weight:700; margin-top: 10px;
                  margin-bottom:10px">Venue</h6>
                  <p style="font-size:15px;">Excepteur sint occaecat cupidatat non proident</p>
                </div>
                <table class="row schedule" style="width: 100%; margin: 0px; margin-top:20px;">
                    <tr>
                      <th style="font-size:14px; font-family: Montserrat-Bold; font-weight:700; text-align: left;padding: 0;">Date</th>
                      <th style="font-size:14px; font-family: Montserrat-Bold; font-weight:700; text-align: left;padding: 0;" >Start Time</th>
                      <th style="font-size:14px; font-family: Montserrat-Bold; font-weight:700; text-align: left;padding: 0;">End Time</th>
                    </tr>
                    <tr>
                      <td style="font-size:15px;">25 September 2018</td>
                      <td style="font-size:15px;">9:30AM</td>
                      <td style="font-size:15px;">11:30AM</td>
                    </tr>
                  </table>
            </td>
          </tr>
            ...
            <td style=" background-color:#F5F5F5;">
                <!-- <div class="footer-logo" style="width: 100%; text-align: center;"> -->
                    ...
                    <!-- <div class="social-icons" style="width: 100%; text-align: center; margin-top: 15px;">
                            ...
                            <i class="fa fa-google-plus" aria-hidden="true" style="margin-right: 15px;"></i>
                            <i class="fa fa-linkedin" aria-hidden="true" style="margin-right: 15px;"></i>
                    </div> -->
                    <div class="copy-right" style="   width: 50%;display: inline; margin-left:30px;">
                           <p style="font-family: 'Montserrat', sans-serif; font-size: 12px;  color: #757575;  letter-spacing: 0.26px;
                           line-height: 22px;margin-top: 30px;  display: inline-flex;"> © Shrimad 2018, All rights Reserved</p>
                    </div>
                    <div class="contact-link" style=" float: right; margin: 30px 30px;">
                        <a href="#" style="font-family: 'Montserrat', sans-serif;font-size: 12px; color: #E76450;    letter-spacing: 0.25px;
                        line-height: 22px; text-decoration: none;">Contact</a>
                    </div>
            </td>
          </tr>
        </table>
